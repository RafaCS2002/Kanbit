...
<body>
    ...
    <div class="wrapper">
        ...
        <div id="content">
			...
			<form action="patientvisu.php" method="post" name="patientvisu_form" id="patientvisu_form">
				<h2>Buscar por informações de um paciente </h2></br>
						...
						if(@$_POST['buscar'] != '' xor @$_GET['busca'] != null){
							...
							?>
								<div class="row" style="border:2px solid #6d7fcc;border-radius:5px 5px 0px 0px;height:30px;">
									<div class="col-md-2" align="center" style="background:#6d7fcc;padding-top:5px;color:white;">Nome</div>
									...
									<div class="col-md-2" align="center" style="background:#6d7fcc;padding-top:5px;border-left:2px solid white;color:white;">Data</div>
									...
									<div class="col-md-2" align="center" style="background:#6d7fcc;padding-top:5px;border-left:2px solid white;color:white;">Estado</div>
								</div>
							<?php
							...
							while($rows = $patientList->fetch_array(MYSQLI_ASSOC)){
								?>
									<div class="row" style="border-bottom:2px solid #6d7fcc;height:27px;">
										<div class="col-md-2" align="center" style="padding-top:5px;color:#6d7fcc;font-size:15px;"><?php echo $rows['nome'];?></div>
										...
										<div class="col-md-2" align="center" style="padding-top:5px;border-left:2px solid #6d7fcc;color:#6d7fcc;font-size:15px;"><?php echo $rows['data'];?></div>
										...
										<div class="col-md-2" align="center" style="padding-top:5px;border-left:2px solid #6d7fcc;color:#6d7fcc;font-size:15px;"><?php echo $rows['estado'];?></div>
									</div>
								<?php
							}
